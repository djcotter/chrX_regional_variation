...
p_PAR1 = p_PAR1 + coord_cartesian(ylim=c(0,1.35)) + geom_hline(yintercept=1.0)
p_PAR1 = p_PAR1 + geom_hline(yintercept=0.75, linetype='dashed')
...
p_X = p_X + coord_cartesian(ylim=c(0,1.35)) + geom_hline(yintercept=1.0)
p_X = p_X + geom_hline(yintercept=0.75, linetype='dashed')
...
p_XTR = p_XTR + coord_cartesian(ylim=c(0,1.35)) + geom_hline(yintercept=1.0)
p_XTR = p_XTR + geom_hline(yintercept=0.75, linetype='dashed')
